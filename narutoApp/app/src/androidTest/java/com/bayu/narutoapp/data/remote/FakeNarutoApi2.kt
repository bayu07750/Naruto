...
class FakeNarutoApi2 : NarutoApi {
    ...
    private val page2 = listOf(
        ...
        Hero(
            ...
            about = "Shikamaru Nara (奈良シカマル, Nara Shikamaru) is a shinobi of Konohagakure's Nara clan. He is known for his high-level intellect and strategic mind, often finding the most efficient and logical solutions to difficult problems. Although he appears lazy and unenthusiastic, Shikamaru is a highly capable ninja and has served his friends and the village with great dedication.",
            rating = 4.5,
            power = 90,
            month = "Sept",
            day = "22nd",
    ...
    private val page3 = listOf(
        Hero(
            ...
            about = "Madara Uchiha (うちはマダラ, Uchiha Madara) was one of the co-founders of Konohagakure and the leader of the Uchiha clan. He was renowned for his extraordinary combat skills and mastery of the Sharingan. Madara was a powerful and ambitious ninja, driven by his desire for peace and the protection of his clan. Throughout his life, he played a significant role in shaping the history of the shinobi world.",
            rating = 5.0,
            power = 99,
            month = "Dec",
            day = "24th",
            family = listOf(
                "Izuna (Younger Brother)"
            ),
            abilities = listOf(
                "Sharingan",
    ...
    private val page4 = listOf(
        Hero(
            id = 13,
            name = "Hashirama",
            image = "/images/hashirama.jpg",
            about = "Hashirama Senju (千手柱間, Senju Hashirama) was one of the co-founders of Konohagakure and the leader of the Senju clan. He was famously known as the \"God of Shinobi\" for his unmatched strength and abilities. Hashirama was a compassionate and wise leader, striving for peace and unity among the ninja clans. He possessed incredible Wood Release techniques and was considered the most powerful shinobi of his time.",
            rating = 5.0,
            power = 100,
            month = "Aug",
            day = "10th",
            family = listOf(
                "Tobirama (Younger Brother)",
                "Mito (Wife)",
